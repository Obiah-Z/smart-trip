...
MOCK_TRAVEL_DATA_PATH = Path(__file__).resolve().parents[2] / "data" / "mock" / "travel_data.json"
CITY_KNOWLEDGE_PATH = Path(__file__).resolve().parents[2] / "data" / "knowledge" / "cities.json"
