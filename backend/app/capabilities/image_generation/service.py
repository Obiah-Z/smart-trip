...
from app.capabilities.image_generation.asset_utils import (
    ImageAssetMeta,
    build_asset_meta,
    lookup_key,
...
from app.capabilities.image_generation.client import GPTImageClient, ImageGenerationRequest
from app.capabilities.image_generation.prompt_builder import (
    ASSET_GROUP_LABELS,
    AssetGroup,
