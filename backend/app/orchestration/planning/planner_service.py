...
from app.orchestration.planning.revision_intent import RevisionIntent, RevisionIntentResolver
...
class PlannerService:
    ...
    REPLAN_UPDATE_KEYWORDS = ("提升", "提高", "增加", "改成", "改为", "调整", "升级", "更舒服", "更舒适","舒适度")
    DESTINATION_UPDATE_KEYWORDS = ("目的地", "城市", "换到", "换成", "换为", "改到", "改成", "改为", "调整到", "调整成", "改去", "换去")
    EXCLUSION_UPDATE_KEYWORDS = ("不想去", "不要去", "不去", "别去", "避开", "去掉", "删掉", "移除")
    PREFERENCE_UPDATE_KEYWORDS = ("想吃", "想住", "想看", "想逛", "多看", "少看", "多安排", "少安排", "优先", "主要", "换成", "换个", "改住", "改吃", "改看", "想要", "尽量")
